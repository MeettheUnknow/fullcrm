...
<script type="text/javascript">
	...
	$(function(){
			...
			$.ajax({
				...
				success : function (data) {
					...
					if(data.success){
						...
						html += '<font color="gray">交易</font> <font color="gray">-</font> <b>${t.name}</b> <small style="color: gray;" id="s'+data.tr.id+'"> '+(data.tr.createTime)+' 由'+(data.tr.createBy)+'</small>';
		...
		$("#editBtn").click(function () {
			...
			window.location.href="workbench/transaction/detail2edit.do?id=${t.id}";
		...
		$("#deleteBtn").click(function () {
			...
			if(confirm("确定删除所选中的记录吗？")){
				...
				window.location.href = "workbench/transaction/deleteDetail.do?id=${t.id}";
...
<!-- 返回按钮 -->
	...
	<div style="position: relative; left: 40px; top: -30px;">
		...
		<div style="position: relative; height: 50px; width: 250px;  top: -72px; left: 700px;">
			<button type="button" class="btn btn-default" id="editBtn" <%--onclick="window.location.href='edit.jsp';"--%>><span class="glyphicon glyphicon-edit"></span> 编辑</button>
