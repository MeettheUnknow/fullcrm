...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#deleteBtn").click(function () {
			...
			window.location.href = "workbench/activity/deleteDetail.do?id=${a.id}";
	...
	<div class="modal-dialog" role="document" style="width: 85%;">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form action="workbench/activity/updateDetail.do" method="post" id="updateFrom" class="form-horizontal" role="form">

					<input type="hidden" id="edit-id" name="id" />

					<div class="form-group">
						<label for="edit-marketActivityOwner" class="col-sm-2 control-label">所有者<span style="font-size: 15px; color: red;">*</span></label>
						<div class="col-sm-10" style="width: 300px;" id="edit-">
					...
					<div class="form-group">
						...
						<div class="col-sm-10" style="width: 300px;">
							<input type="text" class="form-control time" id="edit-startDate" name="startDate">
						</div>
						<label for="edit-endTime" class="col-sm-2 control-label">结束日期</label>
						<div class="col-sm-10" style="width: 300px;">
							<input type="text" class="form-control time" id="edit-endDate" name="endDate">
						</div>
					</div>
