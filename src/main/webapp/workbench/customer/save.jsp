			...
			$("#aname").keydown(function (event) {
				...
				if(event.keyCode==13){
					...
					$.ajax({
						...
						url : "workbench/customer/getActivityListByName.do",
						data : {
			...
			$("#cname").keydown(function (event) {
				...
				if(event.keyCode==13){
					...
					$.ajax({
						...
						url : "workbench/customer/getContactsListByName.do",
						data : {
...
<body>
	...
	<form action="workbench/customer/saveTran.do"  id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-customerName" name="customerName" placeholder="支持自动补全，输入客户不存在则新建" value="${customerName}" readonly />
